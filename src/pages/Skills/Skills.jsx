...
import { BsFileEarmarkCode, BsGrid1X2, BsLayers, BsGithub } from "react-icons/bs";
...
const SkillsSection = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      color: "text-pink-400",
      skills: [
        { name: "VS Code", icon: <BsGithub className="w-4 h-4 text-[#007ACC]" /> },
    ...
    },
    {
      ...
      skills: [
        { name: "Technical Documentation", icon: <BsFileEarmarkCode className="w-4 h-4 text-[#1572B6]" /> },
        { name: "Wireframe Creation", icon: <BsGrid1X2 className="w-4 h-4 text-[#38B2AC]" /> },
        { name: "Design Systems", icon: <BsLayers className="w-4 h-4 text-white" /> },
        { name: "Problem Visualization", icon: <FcWorkflow className="w-4 h-4" /> },
      ],
    },
  ];
